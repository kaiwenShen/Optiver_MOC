...
def run_factor_value(df_dic_sorted, factor_function, factor_name):
    ...
    for date_id in range(start_date, start_date + num_dates):
        for seconds_in_bucket in range(num_seconds_in_bucket):
            ...
            new_test_data = df_dic_sorted[f'{date_id}_{seconds_in_bucket}']
            # time_end_query = time()

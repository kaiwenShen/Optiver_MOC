...
def add_factor_to_OTS_test(factor_name: str) -> None:
    ...
    testing_factors_OTS = load_json('./factor_design_ver3_alpha/testing_factors_OTS.json')
    testing_factors_OTS[factor_name] = []

    with open('./factor_design_ver3_alpha/testing_factors_OTS.json', 'w') as json_file:
